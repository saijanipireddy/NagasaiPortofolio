...
export const about = {
    desc: "Full-Stack Developer with a strong foundation in React.js, Node.js, Express.js, MongoDB, SQL, and Python, currently working at Zithara.AI. Experienced in building and deploying scalable web applications with secure authentication, RESTful APIs, and responsive UI using modern tech stacks including React 18 and Next.js 14.\n\n\tPreviously worked for 1 year at Alstom Transport and 1.6 years at Medha Servo Drives Pvt Limited, where I specialized in real-time data analysis, system validation, and embedded troubleshooting for locomotive systems. Proficient in using DAS software to identify faults, deploy updates, and enhance system reliability.\n\n\tCombining engineering discipline with full-stack expertise, I bring a problem-solving mindset, production-level coding skills, and a passion for building impactful digital solutions.",
    services: [
          {
